...
class TestBlackBoxEnvsion(unittest.TestCase):
    ...
    def test_prev_api_version(self):
        ...
        upper = 5
        lower = 3
        url = f'http://envision-api.ap-southeast-2.elasticbeanstalk.com/api/v1.0.0/?instrument_id={",".join(instr)}&date_of_interest={date}&list_of_var={",".join(var)}&lower_window={lower}&upper_window={upper}'
    ...
    def test_multiple_variables(self):
        instr = ["ABP.AX"]
        date ="2012-12-10"
        var = ["Return", "CM_Return", "AV_Return"]
        upper = 5
        lower = 3
        url = f'http://envision-api.ap-southeast-2.elasticbeanstalk.com/api/v1.0/?instrument_id={",".join(instr)}&date_of_interest={date}&list_of_var={",".join(var)}&lower_window={lower}&upper_window={upper}'
        self._check_envision_success(instr, date, var, upper, lower, url)
...
class TestBlackBoxDistribution(unittest.TestCase):
    # All Empty Parameters
    def test_all_empty_parameters(self):
    ...
    def test_prev_api_version(self):
        ...
        upper = 5
        lower = 3
        url = f'http://team-distribution.info/api/v1/returns?id={",".join(instr)}&date={date}&varlist={",".join(var)}&lower={lower}&upper={upper}'
...
class TestBlackBoxOptiver(unittest.TestCase):
    # All Empty Parameters
    def test_all_empty_parameters(self):
    ...
    def test_prev_api_version(self):
        ...
        upper = 5
        lower = 3
        url = f'http://128.199.82.8:8000/api_v1/api?id={",".join(instr)}&date={date}&type={",".join(var)}&upper_window={upper}&lower_window={lower}'
    ...
    # Potentially dangerous parameters
    def test_dangerous_parameters(self):
        url = 'http://128.199.82.8:8000/api_v2/api?id=");DROP%20TABLE%20RETURNS;--&date=2012-12-10&type=cureturn&upper_window=5&lower_window=3'
        self._check_optiver_failed(url)
